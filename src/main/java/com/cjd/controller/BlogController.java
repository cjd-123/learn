...
public class BlogController {
    ...
    public synchronized String write(QuestionWriteForm questionWriteForm) {
        ...
        blog.setGmtCreate(CjdUtil.getTime());
        blog.setGmtUpdate(CjdUtil.getTime());
        // 存储对象
    ...
    public String editor(Blog blog) {
        ...
        queryBlog.setGmtUpdate(CjdUtil.getTime());
